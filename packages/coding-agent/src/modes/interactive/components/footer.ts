...
export class FooterComponent implements Component {
	...
	render(width: number): string[] {
		// Telemetry (cost, tokens, model, cwd, context %) is hidden by default; /speed opts the
		// footer into a compact tok/sec readout. The stable empty reference keeps the parent
